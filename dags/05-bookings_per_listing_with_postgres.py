...
def bookings_per_listing_with_sensor():
    ...
    def read_bookings_from_postgres():
        ...
        # Let's say this is: 2025-01-15 14:30:00
        ...
        # start_of_minute = 2025-01-15 14:30:00
        
        end_of_minute = start_of_minute + timedelta(minutes=1)  
        # end_of_minute = 2025-01-15 14:31:00
...
# [PostgreSQL Database] → (Real booking data)
#         ↓
# [Bookings CSV] → (Extracted for current minute)
#         ↓
#         +---[JOIN in Spark]---→ [Results: bookings_per_listing]
#         ↓
# [Listings CSV] → (Comes from external source)


# --> The Complete Real-World Pipeline:

# PostgreSQL → Contains real booking transactions from your application
# Airflow → Extracts bookings for each minute (incremental loading)
# FileSensor → Waits for monthly listings data file
# Spark → Joins real bookings with listings → Business analytics